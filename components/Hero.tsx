...
const Hero = () => {
  return (
    <section className="text-neutral-content max-w-7xl mx-auto flex flex-col flex-col-reverse lg:flex-row items-center justify-center gap-8 lg:gap-20 px-8 py-8 lg:py-20">
