...
export default function CitiesPage() {
  ...
  const getSortLabel = (sort: SortOption) => {
    switch (sort) {
      ...
      case "rank": return "Most Popular";
      case "name": return "A-Z";
      case "population": return "Largest Cities";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-blue-600 via-purple-500 to-pink-400 bg-clip-text text-transparent">
            Dance Cities Worldwide
          </h1>
          <p className="text-lg text-base-content/70 max-w-2xl mx-auto">
            Discover vibrant dance communities around the globe. 
            Find your perfect city to dance, connect, and grow.
          </p>
        </div>
        ...
        <div className="mb-8 space-y-4">
          ...
          <div className="text-center text-sm text-base-content/60">
            {loading ? (
              ...
              <span>
                {totalCount > 0 ? `${totalCount} cities found` : 'No cities found'}
        ...
        {cities.length === 0 && !loading && (
          <div className="text-center py-16">
            ...
            <p className="text-base-content/70">
              {searchQuery 
                ? `No cities match "${searchQuery}". Try a different search term.`
